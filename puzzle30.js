...
function calculateScore(sprinklesCount, butterscotchCount, chocolateCount, candyCount, ingredientDetails) {
    var calories = (sprinklesCount * ingredientDetails.Sprinkles.calories) +
                    (butterscotchCount * ingredientDetails.Butterscotch.calories) +
                    (chocolateCount * ingredientDetails.Chocolate.calories) +
                    (candyCount * ingredientDetails.Candy.calories);
